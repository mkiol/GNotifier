 ...
 * Author: Michal Kosciesza <mijkos@gmail.com>
 */
...
function setConfig() {
	...
	ps.set("extensions.gnotify.showAlertOnComplete", v);
...
function restoreOrigConfig() {
	...
	var ps = require("preferences-service");
	var hasOldPref = ps.has("extensions.gnotify.showAlertOnComplete");
	if(hasOldPref) {
		var v = ps.get("extensions.gnotify.showAlertOnComplete");
