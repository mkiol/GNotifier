    ...
    try {
        ...
        let view = {
            onDownloadChanged: function(download) {
                if(sps['downloadCompleteAlert'] && download.succeeded && download.target.exists) {
                    ...
                    if (system.platform != "darwin" && system.platform != "winnt" && loaded)
...
AlertsService.prototype = {
    ...
    showAlertNotification: function GNotifier_AlertsService_showAlertNotification(
        ...
        function GNotifier_AlertsService_showAlertNotification_cb(iconPath) {
            ...
            //console.log("GNotifier_AlertsService_showAlertNotification_cb, iconPath",iconPath);
            //console.log("cookie",cookie);
            //console.log("alertListener type",typeof(alertListener));
            ...
            if (notifyNative(iconPath, title, text, name, closeHandler, clickHandler)) {
                ...
                //console.log("notifyNative success!");
            ...
            try {
                ...
                NetUtil.asyncFetch(imageFile, function(imageStream,result) {
                    ...
                    NetUtil.asyncCopy(imageStream, iconStream, function(result) {
                        ...
                        //console.log("Alerting with icon file:",tempIconFile.path);
                ...
                setTimeout(function(){
                    //console.log("Removing icon file:",tempIconFile.path);
                    tempIconFile.remove(false);
                },2000);

            } catch(e) {

                //console.log("showAlertNotification catch 2",e);
